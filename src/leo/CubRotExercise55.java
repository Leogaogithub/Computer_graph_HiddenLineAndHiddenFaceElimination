...
// Copied from Appendix F (solution to Exercise 5.5) of
...
public class CubRotExercise55 extends Frame
{  public static void main(String[] args){new CubRotExercise55();}
...
class CvCubRot2 extends Canvas
   implements Runnable  
